...
The Identity Service provides enterprise Single Sign-On (SSO) authentication using Google OAuth2/OIDC, role-based access control through Google Groups mapping, and JWT-based authorization with asymmetric keys (RS256).
...
- **Deployment**: See `documents/identity-service-deployment.md`
- **Integration**: See `documents/service-integration-guide.md`
