...
func New(l pkgLog.Logger, uc authentication.UseCase, discord *discord.Discord, cfg *config.Config, jwtManager *pkgJWT.Manager, sessionManager *usecase.SessionManager, googleClient *pkgGoogle.Client, groupsManager *usecase.GroupsManager, roleMapper *usecase.RoleMapper) handler {
	return handler{
		l:              l,
		uc:             uc,
		discord:        discord,
