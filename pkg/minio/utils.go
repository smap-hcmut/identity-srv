...
// generateDownloadHeaders generates HTTP headers for file download
...
// determineContentDisposition determines the appropriate content disposition
...
// generateObjectName generates a unique object name based on original filename
...
// isAudioFile checks if the file is an audio based on content type
...
// sanitizeMetadata cleans and validates metadata
...
// buildObjectPath builds a proper object path from components
