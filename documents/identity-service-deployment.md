...
3. Enter project name: `smap-identity-service`
4. Click **"Create"**
...
```json
{
  ...
  "project_id": "smap-identity-service",
  "private_key_id": "abc123...",
  "private_key": "-----BEGIN PRIVATE KEY-----\n...\n-----END PRIVATE KEY-----\n",
  "client_email": "smap-directory-api@smap-identity-service.iam.gserviceaccount.com",
...
# Configuration
kubectl create secret generic identity-config \
...
kubectl get pods -n identity-service
kubectl get svc -n identity-service
kubectl get ingress -n identity-service

# View logs
kubectl logs -f deployment/identity-service -n identity-service
```
...
# Follow specific pod
kubectl logs -f <pod-name> -n identity-service
```
