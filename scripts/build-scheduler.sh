...
# SMAP Identity Scheduler - Build and Push Script
# Usage: ./build-scheduler.sh [build-push|login|help]
...
PROJECT="smap"
SERVICE="smap-identity-scheduler"
...
show_help() {
    cat << EOF
${GREEN}SMAP Identity Scheduler - Build and Push Script${NC}
